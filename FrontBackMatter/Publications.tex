...
My first publication~\spacedlowsmallcaps{[CMSB'20]} is based on the results that I have achieved in my master thesis. Since all subsequent work is done on formal methods applied to systems biology, this publication gave me a solid foundation in the field. Moreover, it introduced me to the topic of coloured model checking based on BDDs, which is related to the methods I have developed in this manuscript. The context of these methods is described in \autoref{chapter:software}.
