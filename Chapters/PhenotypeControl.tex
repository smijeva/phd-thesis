...
\begin{definition}
  ...
  \begin{itemize}
    \item $\attractor$ \emph{stabilizes} in $\phenotype$ iff $\attractor \cap \phenotype = \attractor$ (or equivalently $\attractor \subseteq \phenotype$).
    ...
    \item $\attractor$ \emph{oscillates} through $\phenotype$ iff $ \attractor \cap \phenotype \neq \emptyset \land \attractor \setminus \phenotype \neq \emptyset$.
  \end{itemize}
