...
\begin{table}[htbp!]
    ...
    CABEAN & \checkmark & \checkmark & \checkmark &  &  & OTP & \checkmark & & Strong basin search, ASP \\
    BoolNet & \checkmark & \checkmark* & \checkmark* & \checkmark &  & OP & \checkmark & & Trap spaces, model checking \\
    KALI & \checkmark & &  & \checkmark** & & P &  &  & Simulations \\
    CASPO   &  &  & \checkmark & \checkmark & \checkmark & P & \checkmark & & ASP \\
    BoNesis & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & P & \checkmark & & ASP \\
    AEON    & \checkmark & \textcolor{gray}{\checkmark} & \textcolor{gray}{\checkmark} & \textcolor{gray}{\checkmark} & \textcolor{gray}{\checkmark} & \textcolor{gray}{OTP***} & \checkmark & \checkmark & Symbolic BDDs
    \end{tabular}
    } 
\end{table}
