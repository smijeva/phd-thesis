...
One-step perturbations are suboptimal when compared to the perturbations applied for a longer period of time. Therefore, we also developed methods for permanent and temporary perturbations, which are more complex but can yield smaller perturbations.
