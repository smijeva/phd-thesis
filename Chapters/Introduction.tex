...
\begin{enumerate}
    ...
    \item Permanent phenotype control method for \PBN{} with symbolic state space exploration and result requiring explicit enumeration which is described in \autoref{chapter:phenotype_control_psbn}~\cite{Benes2023b}
\end{enumerate}
...
Finally, \hyperref[chapter:conclusion]{Conclusions} summarizes the main contributions of this thesis and discusses possible future directions for research in this area.