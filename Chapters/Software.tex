...
The core structure of the \texttt{biodivine-pbn-control} repository follows the standard layout of a Rust library project managed using Cargo. The main components of the repository are illustrated below:
