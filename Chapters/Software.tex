...
This library was used to provide all reachability, trap set and attractor computations for the control algorithms implemented in this thesis that are described in \textcolor{red}{TODO add ref to chapter 4 or 5}.

Previously the library used semi-symbolic representation of the state space, where only interpretations were represented symbolically, while states were represented explicitly. This approach was used in the initial version of the control algorithms implemented in this thesis, which are described in \textcolor{red}{TODO add ref to chapter 4}.
